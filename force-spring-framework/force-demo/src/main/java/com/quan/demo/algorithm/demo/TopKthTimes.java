...
public class TopKthTimes {
    ...
    public static void printTopKthAndRank(String[] arr, int topKth) {
        if (arr == null || arr.length == 0 || topKth < 1 || topKth > arr.length) {
            return;
        }
    ...
    public static void main(String[] args) {
        ...
        printTopKthAndRank(arr1, 2);

        String[] arr2 = generateRandomArray(50, 10);
        int topK = 3;
        printArray(arr2);
        printTopKthAndRank(arr2, topK);
