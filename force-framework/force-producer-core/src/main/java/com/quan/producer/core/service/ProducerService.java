...
import com.quan.producer.core.util.ProducerUtils;
 ...
 * @description ProducerService 群推生产，过滤，存储一体化API封装
 * @date 2021-09-27
 **/
public interface ProducerService<T> {
    ...
    default void destroy(Context<T> context) {
        //ThreadLocalUtil.remove(ContextConstants.CONTEXT);
    }
    ...
    default void prepareContext(Context<T> context) {
        ...
        //ThreadLocalUtil.put(ContextConstants.CONTEXT, context);
    }
