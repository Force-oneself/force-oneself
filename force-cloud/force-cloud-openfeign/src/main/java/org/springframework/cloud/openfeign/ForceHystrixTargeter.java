...
import com.quan.openfeign.fallback.SimpleFallbackFactory;
import feign.Feign;
import feign.Target;
...
/**
 * WinkeyHystrixTargeter
 *
 * @author Force-oneself
 * @date 2022-11-25
 */
@SuppressWarnings("unchecked")
public class ForceHystrixTargeter implements Targeter {
    ...
    public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
        ...
        FallbackFactory<T> defaultFallbackFactory = new SimpleFallbackFactory<>(target);
        return builder.target(target, defaultFallbackFactory);
    }
